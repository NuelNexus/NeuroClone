...
def create_llm(cfg: LLMConfig) -> LLM:
    ...
    if provider in ("openai", "openai_compat", "ollama", "lmstudio", "llamacpp", "vllm", "openrouter"):
    ...
    raise LLMError(f"unknown llm.provider {cfg.provider!r} (use openai, anthropic, or mock)")
